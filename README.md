...
## 🗃️ Contacts Workspace (Assignment Fork)

This repository includes a **Contacts Workspace** assignment implementation. See **[Assignment.md](./Assignment.md)** for the full assignment brief, setup instructions, architecture, API reference, and design-question answers.
