...
export const contactById = (id: string) => `${contacts()}/${encodeURIComponent(id)}`;
export const searchContacts = () => `${contacts()}/search`;
export const contactDiskSpace = () => `${contacts()}/disk-space`;
export const importContacts = () => `${contacts()}/import`;
export const importContactsStatus = (jobId: string) => `${contacts()}/import/${encodeURIComponent(jobId)}`;
